...
"""
from examples import BookExamples
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            yager_result, _, _, _ = BookExamples.example_2_8()
            DSVisualizer.plot_bpa_distribution(yager_result, "Пример 2.8: Правило Ягера")
            
        elif choice == '5':
            yager_result, dempster_result, bpa1, bpa2 = BookExamples.compare_dempster_yager()
            ...
            bpa_2_1 = BookExamples.example_2_1()
            ...
            bpa_2_2 = BookExamples.example_2_2()
            ...
            bpa_2_6 = BookExamples.example_2_6()
